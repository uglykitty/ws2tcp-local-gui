...
QString singleInstanceServerName() {
  ...
  return QStringLiteral("ws2tcp-local-gui-%1").arg(QString::fromLatin1(userId));
}
...
int main(int argc, char *argv[]) {
  ...
  QCoreApplication::setApplicationName("ws2tcp-local-gui");
  ...
  if (language == "zh_CN" &&
      appTranslator.load(QStringLiteral(":/i18n/ws2tcp-local-gui_zh_CN.qm"))) {
